...
private:
    ...
    template <
        ...
        HRESULT (__stdcall ID3D11Device::*OrigCreateShader)(
            ...
            __in_opt ID3D11ClassLinkage* pClassLinkage,
            __out_opt ID3D11Shader** ppShader)>
    STDMETHODIMP CreateShader(__in const void* pShaderBytecode, __in SIZE_T BytecodeLength, __in_opt ID3D11ClassLinkage* pClassLinkage, __out_opt ID3D11Shader** ppShader, wchar_t* shaderType);
