...
public:
	...
	static D3D11Wrapper::ID3D11Device* GetDirect3DDevice(D3D11Base::ID3D11Device *pDevice);
	static __forceinline D3D11Base::ID3D11Device *GetD3D11Device() { return (D3D11Base::ID3D11Device*) m_pUnk; }
