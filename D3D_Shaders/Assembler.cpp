...
//static vector<DWORD> assembleInsDX9(string s) {
//	unsigned msaa_samples = 0;
//
//	if (hackMap.find(s) != hackMap.end()) {
//		auto v = hackMap[s];
...
//	else if (o.substr(0, 3) == "ps_") {
//		op = 0xFFFF0000;
//		op |= 256 * atoi(o.substr(3, 1).c_str());
//		op |= atoi(o.substr(5, 1).c_str());
//		v.push_back(op);
//	}
//	else if (o.substr(0, 3) == "vs_") {
...
//	return v;
//}
//static string assembleAndCompareDX9(string s, vector<DWORD> v) {
//	string s2;
//	int numSpaces = 0;
...
//	size_t lastEnd = 0;
//	vector<DWORD> v2 = assembleInsDX9(s);
//	string sNew = s;
//	string s3;
//	bool valid = true;
//	if (v2.size() > 0) {
