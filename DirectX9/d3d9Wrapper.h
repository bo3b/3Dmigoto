...
typedef HRESULT (WINAPI *D3DCREATEEX)(UINT, D3D9Base::LPDIRECT3D9EX *ppD3D);
...
public:
	...
	bool _ex;
	bool m_isRESZ;
	IDirect3D9(D3D9Base::LPDIRECT3D9 pD3D, bool ex);
	static IDirect3D9* GetDirect3D(D3D9Base::LPDIRECT3D9 pD3D, bool ex);
	__forceinline D3D9Base::LPDIRECT3D9 GetDirect3D9() { return (D3D9Base::LPDIRECT3D9)m_pUnk; }
	__forceinline D3D9Base::LPDIRECT3D9EX GetDirect3D9Ex() { return (D3D9Base::LPDIRECT3D9EX)m_pUnk; }
    ...
    STDMETHOD(CreateDevice)(THIS_ UINT Adapter,D3D9Base::D3DDEVTYPE DeviceType,HWND hFocusWindow,DWORD BehaviorFlags,D3D9Base::D3DPRESENT_PARAMETERS* pPresentationParameters,D3D9Wrapper::IDirect3DDevice9** ppReturnedDeviceInterface) ;
...
struct DepthSourceInfo
{
	...
	D3D9Base::D3DCMPFUNC last_cmp_func;
...
struct DrawContext
{
	...
	DrawContext(DrawCall type, D3D9Base::D3DPRIMITIVETYPE primitive_type,
		UINT PrimitiveCount,
		UINT StartVertex,
		INT BaseVertexIndex,
		UINT MinVertexIndex,
...
#define D3DFMT_RESZ ((D3D9Base::D3DFORMAT)(MAKEFOURCC('R','E','S','Z')))
#define D3DFMT_INTZ ((D3D9Base::D3DFORMAT)(MAKEFOURCC('I','N','T','Z')))
#define RESZ_CODE 0x7fa05000
#define	NULL_CODE	((D3D9Base::D3DFORMAT)(MAKEFOURCC('N','U','L','L')))
...
public:
	...
	D3D9Base::D3DCMPFUNC current_zfunc;

	vector<D3D9Base::IDirect3DResource9*> nvapi_registered_resources;
	HRESULT NVAPIStretchRect(D3D9Base::IDirect3DResource9 *src, D3D9Base::IDirect3DResource9 *dst, RECT *srcRect, RECT *dstRect);
	...
	D3D9Base::IDirect3DTexture9 *cursor_mask_tex;
	D3D9Base::IDirect3DTexture9 *cursor_color_tex;
	...
	bool isViewportDefaultForMainRT(CONST D3D9Base::D3DVIEWPORT9* pViewport);
	D3D9Base::D3DVIEWPORT9 m_LastViewportSet;
	...
	D3D9Base::IDirect3DSurface9 *DirectModeIntermediateRT;
	...
	D3D9Base::D3DXMATRIX m_gameProjection;
	D3D9Base::D3DXMATRIX m_leftProjection;
	D3D9Base::D3DXMATRIX m_rightProjection;
	D3D9Base::D3DXMATRIX m_currentProjection;
	...
	void HackerDeviceUnWrapTexture(D3D9Wrapper::IDirect3DBaseTexture9* pWrappedTexture, D3D9Base::IDirect3DBaseTexture9** ppActualLeftTexture, D3D9Base::IDirect3DBaseTexture9** ppActualRightTexture);
	void OnCreateOrRestore(D3D9Base::D3DPRESENT_PARAMETERS* pOrigParams, D3D9Base::D3DPRESENT_PARAMETERS* pNewParams);
	...
	D3D9Base::D3DPRESENT_PARAMETERS _pOrigPresentationParameters;
	...
	bool _ex;
	D3D9Base::IDirect3DVertexBuffer9 *mClDrawVertexBuffer;
	D3D9Base::IDirect3DVertexDeclaration9 *mClDrawVertexDecl;
	...
	void TrackAndDivertLock(HRESULT lock_hr, Surface *pResource,
		D3D9Base::D3DLOCKED_RECT *pLockedRect, DWORD MapFlags, UINT Level = 0);
	void TrackAndDivertLock(HRESULT lock_hr, D3D9Wrapper::IDirect3DVolumeTexture9 *pResource,
		 D3D9Base::D3DLOCKED_BOX *pLockedRect, DWORD MapFlags, UINT Level);
	...
	D3D9Base::IDirect3DTexture9 *mStereoTexture;
	...
	D3D9Base::IDirect3DDevice9* GetPassThroughOrigDevice();
	void HookDevice();
    ...
    IDirect3DDevice9(D3D9Base::LPDIRECT3DDEVICE9 pDevice, D3D9Wrapper::IDirect3D9 *pD3D, bool ex);
    static IDirect3DDevice9* GetDirect3DDevice(D3D9Base::LPDIRECT3DDEVICE9 pDevice, D3D9Wrapper::IDirect3D9 *pD3D, bool ex);
	__forceinline D3D9Base::LPDIRECT3DDEVICE9 GetD3D9Device() { return (D3D9Base::LPDIRECT3DDEVICE9) m_pUnk; }
	__forceinline D3D9Base::LPDIRECT3DDEVICE9EX GetD3D9DeviceEx() { return (D3D9Base::LPDIRECT3DDEVICE9EX) m_pUnk; }
...
// public to allow CommandList access
	...
	virtual void FrameAnalysisDump(D3D9Base::IDirect3DResource9 *resource, FrameAnalysisOptions options,
	...
	virtual void FrameAnalysisLogResourceHash(D3D9Base::IDirect3DResource9 *resource) {};
	virtual void FrameAnalysisAfterUnlock(D3D9Base::IDirect3DResource9 *resource) {};
	virtual void FrameAnalysisLogResource(int slot, char *slot_name, D3D9Base::IDirect3DResource9 *resource) {};
	virtual void FrameAnalysisLogQuery(D3D9Base::IDirect3DQuery9 *query) {};
	...
	private:
		...
		void SwitchPSShader(D3D9Base::IDirect3DPixelShader9 *shader);
		void SwitchVSShader(D3D9Base::IDirect3DVertexShader9 *shader);
		...
		HRESULT _SetTexture(DWORD Sampler, D3D9Base::IDirect3DBaseTexture9 *pTexture);
...
public:
	...
	D3D9Base::D3DPRESENT_PARAMETERS origPresentationParameters;
	...
	inline D3D9Base::LPDIRECT3DSWAPCHAIN9 GetSwapChain9() { return (D3D9Base::LPDIRECT3DSWAPCHAIN9)m_pUnk; }
	inline D3D9Base::LPDIRECT3DSWAPCHAIN9EX GetSwapChain9Ex() { return (D3D9Base::LPDIRECT3DSWAPCHAIN9EX)m_pUnk; }
    ...
    STDMETHOD(GetBackBuffer)(THIS_ UINT iBackBuffer,D3D9Base::D3DBACKBUFFER_TYPE Type, D3D9Wrapper::IDirect3DSurface9 **ppBackBuffer);
	...
	STDMETHOD(GetPresentStats)(D3D9Base::D3DPRESENTSTATS *pPresentationStatistics);
...
protected:
	D3D9Wrapper::IDirect3DDevice9 *hackerDevice;
public:
	IDirect3DResource9(D3D9Base::LPDIRECT3DRESOURCE9 pResource, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	__forceinline D3D9Base::LPDIRECT3DRESOURCE9 GetD3DResource9() { return (D3D9Base::LPDIRECT3DRESOURCE9)m_pUnk; }
...
struct D3DLockedRect {
	D3D9Base::D3DLOCKED_RECT lockedRect;
	RECT rect;
	DWORD flags;
};
...
{
private:
	D3D9Base::IDirect3DSurface9* m_pDirectSurfaceRight;
	D3D9Base::IDirect3DTexture9* m_pDirectLockableSysMemTexture;
	std::mutex m_mtx;
	bool DirectFullSurface;
	D3D9Base::D3DLOCKED_RECT DirectLockedRect;
...
public:
	...
	D3D9Base::IDirect3DSurface9* DirectModeGetMono();
	D3D9Base::IDirect3DSurface9* DirectModeGetLeft();
	D3D9Base::IDirect3DSurface9* DirectModeGetRight();
	...
	D3D9Base::IDirect3DTexture9 *depthstencil_replacement_texture;
	D3D9Base::IDirect3DSurface9 *depthstencil_replacement_surface;
	D3D9Base::IDirect3DSurface9 *depthstencil_multisampled_rt_surface;
	...
	D3D9Base::D3DCUBEMAP_FACES _FaceType;
	DWORD _Usage;

	void HookSurface();

	IDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface);
	IDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DSwapChain9 *owningContainer);
	IDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DTexture9 *owningContainer);
	IDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DCubeTexture9 *owningContainer);
	static IDirect3DSurface9* GetDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface);
	static IDirect3DSurface9* GetDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DSwapChain9 *owningContainer);
	static IDirect3DSurface9* GetDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DTexture9 *owningContainer);
	static IDirect3DSurface9* GetDirect3DSurface9(D3D9Base::LPDIRECT3DSURFACE9 pSurface, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DSURFACE9 pDirectModeRightSurface, D3D9Wrapper::IDirect3DCubeTexture9 *owningContainer);
...
public:
	...
	IDirect3DVertexDeclaration9(D3D9Base::LPDIRECT3DVERTEXDECLARATION9 pVertexDeclaration, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DVertexDeclaration9* GetDirect3DVertexDeclaration9(D3D9Base::LPDIRECT3DVERTEXDECLARATION9 pVertexDeclaration, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
...
public:
	...
	IDirect3DBaseTexture9(D3D9Base::LPDIRECT3DBASETEXTURE9 pTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, TextureType type);
	__forceinline D3D9Base::LPDIRECT3DBASETEXTURE9 GetD3DBaseTexture9() { return (D3D9Base::LPDIRECT3DBASETEXTURE9) m_pUnk; }
};
...
private:
	...
	D3D9Base::IDirect3DTexture9* m_pDirectTextureRight;
	std::mutex m_mtx;
	...
	std::unordered_map<UINT, D3D9Base::IDirect3DTexture9*> m_pDirectLockableSysMemTextures;
	bool DirectLockRectNoMemTex;
...
public:
	...
	D3D9Base::IDirect3DTexture9* DirectModeGetMono();
	D3D9Base::IDirect3DTexture9* DirectModeGetLeft();
	D3D9Base::IDirect3DTexture9* DirectModeGetRight();
    static ThreadSafePointerSet m_List;
	// Delayed creation parameters.
	//int magic;
	UINT _Width;
	...
	IDirect3DTexture9(D3D9Base::LPDIRECT3DTEXTURE9 pTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DTEXTURE9 pDirectModeRightSurface);
    static IDirect3DTexture9* GetDirect3DTexture9(D3D9Base::LPDIRECT3DTEXTURE9 pTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DTEXTURE9 pDirectModeRightSurface);
...
public:
	...
	IDirect3DVertexBuffer9(D3D9Base::LPDIRECT3DVERTEXBUFFER9 pVertexBuffer, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DVertexBuffer9* GetDirect3DVertexBuffer9(D3D9Base::LPDIRECT3DVERTEXBUFFER9 pVertexBuffer, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
...
public:
	...
	IDirect3DIndexBuffer9(D3D9Base::LPDIRECT3DINDEXBUFFER9 pIndexBuffer, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DIndexBuffer9* GetDirect3DIndexBuffer9(D3D9Base::LPDIRECT3DINDEXBUFFER9 pIndexBuffer, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
...
public:
	...
	IDirect3DQuery9(D3D9Base::LPDIRECT3DQUERY9 pQuery, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DQuery9* GetDirect3DQuery9(D3D9Base::LPDIRECT3DQUERY9 pQuery, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
...
public:
	...
	__forceinline D3D9Base::LPDIRECT3DPIXELSHADER9 GetZeroPixelShader() { return (D3D9Base::LPDIRECT3DPIXELSHADER9)zeroShader; };
	__forceinline D3D9Base::LPDIRECT3DVERTEXSHADER9 GetZeroVertexShader() { return (D3D9Base::LPDIRECT3DVERTEXSHADER9)zeroShader; };
...
public:
    ...
    static ThreadSafePointerSet m_List;
	IDirect3DVertexShader9(D3D9Base::LPDIRECT3DVERTEXSHADER9 pVS, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DVertexShader9* GetDirect3DVertexShader9(D3D9Base::LPDIRECT3DVERTEXSHADER9 pVS, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
...
public:
	...
	IDirect3DPixelShader9(D3D9Base::LPDIRECT3DPIXELSHADER9 pPS, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
    static IDirect3DPixelShader9* GetDirect3DPixelShader9(D3D9Base::LPDIRECT3DPIXELSHADER9 pPS, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	__forceinline D3D9Base::LPDIRECT3DPIXELSHADER9 GetD3DPixelShader9() { return (D3D9Base::LPDIRECT3DPIXELSHADER9)m_pUnk; };
...
private:
	std::unordered_map<UINT, D3D9Wrapper::IDirect3DSurface9*> m_wrappedSurfaceLevels;
	D3D9Base::IDirect3DCubeTexture9* m_pDirectCubeTextureRight;
	std::mutex m_mtx;
	std::unordered_map<UINT, std::vector<D3DLockedRect>> DirectLockedRects;
	std::unordered_map<UINT, bool> DirectFullSurfaces;
	std::unordered_map<UINT, bool> DirectNewSurface;
	std::unordered_map<UINT, D3D9Base::IDirect3DCubeTexture9*> m_pDirectLockableSysMemTextures;
	bool DirectLockRectNoMemTex;
...
public:
	...
	D3D9Base::IDirect3DCubeTexture9* DirectModeGetMono();
	D3D9Base::IDirect3DCubeTexture9* DirectModeGetLeft();
	D3D9Base::IDirect3DCubeTexture9* DirectModeGetRight();
	...
	IDirect3DCubeTexture9(D3D9Base::LPDIRECT3DCUBETEXTURE9 pCubeTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DCUBETEXTURE9 pDirectModeRightCubeTexture);
	static IDirect3DCubeTexture9* GetDirect3DCubeTexture9(D3D9Base::LPDIRECT3DCUBETEXTURE9 pCubeTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Base::LPDIRECT3DCUBETEXTURE9 pDirectModeRightCubeTexture);
	__forceinline D3D9Base::LPDIRECT3DCUBETEXTURE9 GetD3DCubeTexture9() { return (D3D9Base::LPDIRECT3DCUBETEXTURE9) m_pUnk; }
	...
	STDMETHOD(GetLevelDesc)(THIS_ UINT Level, D3D9Base::D3DSURFACE_DESC *pDesc);
	STDMETHOD(GetCubeMapSurface)(THIS_ D3D9Base::D3DCUBEMAP_FACES FaceType, UINT Level, D3D9Wrapper::IDirect3DSurface9 **ppCubeMapSurface);
	STDMETHOD(LockRect)(THIS_ D3D9Base::D3DCUBEMAP_FACES FaceType, UINT Level, D3D9Base::D3DLOCKED_RECT* pLockedRect, CONST RECT* pRect, DWORD Flags);
	STDMETHOD(UnlockRect)(THIS_ D3D9Base::D3DCUBEMAP_FACES FaceType, UINT Level);
	STDMETHOD(AddDirtyRect)(THIS_ D3D9Base::D3DCUBEMAP_FACES FaceType, CONST RECT* pDirtyRect);
};
...
public:
	...
	IDirect3DVolumeTexture9(D3D9Base::LPDIRECT3DVOLUMETEXTURE9 pVolumeTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	static IDirect3DVolumeTexture9* GetDirect3DVolumeTexture9(D3D9Base::LPDIRECT3DVOLUMETEXTURE9 pVolumeTexture, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	__forceinline D3D9Base::LPDIRECT3DVOLUMETEXTURE9 GetD3DVolumeTexture9() { return (D3D9Base::LPDIRECT3DVOLUMETEXTURE9) m_pUnk; }
	...
	STDMETHOD(GetLevelDesc)(THIS_ UINT Level, D3D9Base::D3DVOLUME_DESC *pDesc);
	STDMETHOD(GetVolumeLevel)(THIS_ UINT Level, D3D9Wrapper::IDirect3DVolume9 **ppVolumeLevel);
	STDMETHOD(LockBox)(THIS_ UINT Level, D3D9Base::D3DLOCKED_BOX *pLockedVolume, CONST D3D9Base::D3DBOX *pBox, DWORD Flags);
	STDMETHOD(UnlockBox)(THIS_ UINT Level);
	STDMETHOD(AddDirtyBox)(THIS_ CONST D3D9Base::D3DBOX *pDirtyBox);
};
...
public:
	...
	IDirect3DVolume9(D3D9Base::LPDIRECT3DVOLUME9 pVolume, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Wrapper::IDirect3DVolumeTexture9 *owningContainer);
	static IDirect3DVolume9* GetDirect3DVolume9(D3D9Base::LPDIRECT3DVOLUME9 pVolume, D3D9Wrapper::IDirect3DDevice9 *hackerDevice, D3D9Wrapper::IDirect3DVolumeTexture9 *owningContainer);

	D3D9Wrapper::IDirect3DVolumeTexture9 *m_OwningContainer;
	__forceinline D3D9Base::LPDIRECT3DVOLUME9 GetD3DVolume9() { return (D3D9Base::LPDIRECT3DVOLUME9)m_pUnk; }
	...
	STDMETHOD(GetContainer)(THIS_ REFIID riid, void** ppContainer);
	STDMETHOD(GetDesc)(THIS_ D3D9Base::D3DVOLUME_DESC *pDesc);
	STDMETHOD(LockBox)(THIS_ D3D9Base::D3DLOCKED_BOX *pLockedVolume, CONST D3D9Base::D3DBOX *pBox, DWORD Flags);
...
public:
	void Delete();
	static ThreadSafePointerSet m_List;
	D3D9Base::IDirect3DStateBlock9 *mDirectModeStateBlockDuplication;
	void HookStateBlock();

	IDirect3DStateBlock9(D3D9Base::LPDIRECT3DSTATEBLOCK9 pStateBlock, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	static IDirect3DStateBlock9* GetDirect3DStateBlock9(D3D9Base::LPDIRECT3DSTATEBLOCK9 pStateBlock, D3D9Wrapper::IDirect3DDevice9 *hackerDevice);
	__forceinline D3D9Base::LPDIRECT3DSTATEBLOCK9 GetD3DStateBlock9() { return (D3D9Base::LPDIRECT3DSTATEBLOCK9)m_pUnk; }
