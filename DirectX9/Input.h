...
class InputListener {
public:
	virtual void DownEvent(D3D9Wrapper::IDirect3DDevice9 *device) = 0;
	virtual void UpEvent(D3D9Wrapper::IDirect3DDevice9 *device);
};
...
typedef void(*InputCallback)(D3D9Wrapper::IDirect3DDevice9 *device, void *private_data);
...
public:
	...
	void DownEvent(D3D9Wrapper::IDirect3DDevice9 *device) override;
	void UpEvent(D3D9Wrapper::IDirect3DDevice9 *device) override;
};
...
public:
	...
	virtual bool Dispatch(D3D9Wrapper::IDirect3DDevice9 *device);
};
