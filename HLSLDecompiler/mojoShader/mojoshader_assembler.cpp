...
static inline void out_of_memory(AssemblerContext *ctx)
{
    ctx->isfail = ctx->out_of_memory = 1;
} // out_of_memory

static inline void *Malloc(AssemblerContext *ctx, const size_t len)
{
...
static inline char *StrDup(AssemblerContext *ctx, const char *str)
{
...
static inline void Free(AssemblerContext *ctx, void *ptr)
{
...
{
	return Malloc((AssemblerContext *)data, (size_t)bytes);
} // MallocBridge

static void FreeBridge(void *ptr, void *data)
{
	Free((AssemblerContext *)data, ptr);
} // FreeBridge


static void failf(AssemblerContext *ctx, const char *fmt, ...) ISPRINTF(2, 3);
static void failf(AssemblerContext *ctx, const char *fmt, ...)
{
    ctx->isfail = 1;
...
static inline void fail(AssemblerContext *ctx, const char *reason)
{
    failf(ctx, "%s", reason);
} // fail

static inline int isfail(const AssemblerContext *ctx)
{
    return ctx->isfail;
} // isfail
...
static inline int shader_version_atleast(const AssemblerContext *ctx, const uint8 maj,
                                         const uint8 min)
{
    return (ver_ui32(ctx->major_ver, ctx->minor_ver) >= ver_ui32(maj, min));
} // shader_version_atleast

static inline int shader_is_pixel(const AssemblerContext *ctx)
{
    return (ctx->shader_type == MOJOSHADER_TYPE_PIXEL);
} // shader_is_pixel

static inline int shader_is_vertex(const AssemblerContext *ctx)
{
    return (ctx->shader_type == MOJOSHADER_TYPE_VERTEX);
} // shader_is_vertex

static inline void pushback(AssemblerContext *ctx)
{
    #if DEBUG_ASSEMBLER_PARSER
...
static Token nexttoken(AssemblerContext *ctx)
{
    if (ctx->pushedback)
        ctx->pushedback = 0;
    else
...
static void output_token_noswap(AssemblerContext *ctx, const uint32 token)
{
    if (!isfail(ctx))
    {
...
static inline void output_token(AssemblerContext *ctx, const uint32 token)
{
    output_token_noswap(ctx, SWAP32(token));
} // output_token


static void output_comment_bytes(AssemblerContext *ctx, const uint8 *buf, size_t len)
{
...
static inline void output_comment_string(AssemblerContext *ctx, const char *str)
{
    output_comment_bytes(ctx, (const uint8 *) str, strlen(str));
} // output_comment_string


static int require_comma(AssemblerContext *ctx)
{
...
static int check_token_segment(AssemblerContext *ctx, const char *str)
{
...
static int check_token(AssemblerContext *ctx, const char *str)
{
    const size_t len = strlen(str);
    if ( (ctx->tokenlen != len) || (strncasecmp(ctx->token, str, len) != 0) )
        return 0;
...
static int ui32fromtoken(AssemblerContext *ctx, uint32 *_val)
{
    unsigned int i;
...
static int parse_register_name(AssemblerContext *ctx, RegisterType *rtype, int *rnum)
{
...
static void set_result_shift(AssemblerContext *ctx, DestArgInfo *info, const int val)
{
...
static inline int tokenbuf_overflow(AssemblerContext *ctx)
{
...
static int parse_destination_token(AssemblerContext *ctx)
{
...
static void set_source_mod(AssemblerContext *ctx, const int negate,
...
static int parse_source_token_maybe_relative(AssemblerContext *ctx, const int relok)
{
    int retval = 1;
...
static inline int parse_source_token(AssemblerContext *ctx)
{
    return parse_source_token_maybe_relative(ctx, 1);
} // parse_source_token


static int parse_args_NULL(AssemblerContext *ctx)
{
    return 1;
} // parse_args_NULL


static int parse_num(AssemblerContext *ctx, const int floatok, uint32 *value)
{
...
static int parse_args_DEFx(AssemblerContext *ctx, const int isflt)
{
...
static int parse_args_DEF(AssemblerContext *ctx)
{
    return parse_args_DEFx(ctx, 1);
} // parse_args_DEF


static int parse_args_DEFI(AssemblerContext *ctx)
{
    return parse_args_DEFx(ctx, 0);
} // parse_args_DEFI


static int parse_args_DEFB(AssemblerContext *ctx)
{
    parse_destination_token(ctx);
    require_comma(ctx);
...
static int parse_dcl_usage(AssemblerContext *ctx, uint32 *val, int *issampler)
{
    size_t i;
...
static int parse_args_DCL(AssemblerContext *ctx)
{
    int issampler = 0;
    uint32 usage = 0;
    uint32 index = 0;
...
static int parse_args_D(AssemblerContext *ctx)
{
    int retval = 1;
...
static int parse_args_S(AssemblerContext *ctx)
{
    int retval = 1;
...
static int parse_args_SS(AssemblerContext *ctx)
{
    int retval = 1;
    retval += parse_source_token(ctx);
    require_comma(ctx);
...
static int parse_args_DS(AssemblerContext *ctx)
{
    int retval = 1;
    retval += parse_destination_token(ctx);
    require_comma(ctx);
...
static int parse_args_DSS(AssemblerContext *ctx)
{
    int retval = 1;
    retval += parse_destination_token(ctx);
    require_comma(ctx);
...
static int parse_args_DSSS(AssemblerContext *ctx)
{
    int retval = 1;
    retval += parse_destination_token(ctx);
    require_comma(ctx);
...
static int parse_args_DSSSS(AssemblerContext *ctx)
{
    int retval = 1;
    retval += parse_destination_token(ctx);
    require_comma(ctx);
...
static int parse_args_SINCOS(AssemblerContext *ctx)
{
...
static int parse_args_TEXCRD(AssemblerContext *ctx)
{
...
static int parse_args_TEXLD(AssemblerContext *ctx)
{
...
typedef int(*args_function)(AssemblerContext *ctx);
...
static int parse_condition(AssemblerContext *ctx, uint32 *controls)
{
...
static int parse_instruction_token(AssemblerContext *ctx, Token token)
{
    int coissue = 0;
    int predicated = 0;
...
static void parse_version_token(AssemblerContext *ctx)
{
    int bad = 0;
    int dot_form = 0;
...
static void parse_phase_token(AssemblerContext *ctx)
{
    output_token(ctx, 0x0000FFFD); // phase token always 0x0000FFFD.
} // parse_phase_token


static void parse_end_token(AssemblerContext *ctx)
{
...
static void parse_token(AssemblerContext *ctx, const Token token)
{
    if (token != TOKEN_IDENTIFIER)
...
static void destroy_context(AssemblerContext *ctx)
{
    if (ctx != NULL)
    {
...
static AssemblerContext *build_context(const char *filename,
                              ...
                              MOJOSHADER_malloc m, MOJOSHADER_free f, void *d)
{
	...
	AssemblerContext *ctx = (AssemblerContext *)m(sizeof (AssemblerContext), d);
    if (ctx == NULL)
        return NULL;
...
static const MOJOSHADER_parseData *build_failed_assembly(AssemblerContext *ctx)
{
    assert(isfail(ctx));
...
static uint32 add_ctab_bytes(AssemblerContext *ctx, const uint8 *bytes, const size_t len)
{
    if (isfail(ctx))
        return 0;
...
static inline uint32 add_ctab_string(AssemblerContext *ctx, const char *str)
{
    return add_ctab_bytes(ctx, (const uint8 *) str, strlen(str) + 1);
} // add_ctab_string


static uint32 add_ctab_typeinfo(AssemblerContext *ctx, const MOJOSHADER_symbolTypeInfo *info);

static uint32 add_ctab_members(AssemblerContext *ctx, const MOJOSHADER_symbolTypeInfo *info)
{
    unsigned int i;
...
static uint32 add_ctab_info(AssemblerContext *ctx, const MOJOSHADER_symbol *symbols,
...
static void output_ctab(AssemblerContext *ctx, const MOJOSHADER_symbol *symbols,
...
static void output_comments(AssemblerContext *ctx, const char **comments,
...
static const MOJOSHADER_parseData *build_final_assembly(AssemblerContext *ctx)
{
    if (isfail(ctx))
	...
	retval->bytecode = bytecode;
	retval->bytecode_len = output_len;
    //Free(ctx, bytecode);
