...
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\DiRT Rally\" /F /Y /S
...
@echo on
echo 
REM xcopy /C "%1*.*" "W:\Games\Watch_Dogs\bin"  /F /Y /S
REM xcopy /C "%1*.*" "W:\Games\Far Cry 4\bin\" /F /Y /S
REM xcopy /C "%1*.*" "W:\Games\The Witcher 3 Wild Hunt\bin\x64\" /F /Y /S
REM xcopy /C "%1*.*" "W:\Games\The Crew (Worldwide)\" /F /Y /S
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Call of Duty Ghosts\"  /F /Y /S
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\ShadowOfMordor\x64\" /F /Y /S
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Project CARS\" /F /Y /S
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Metal Gear Solid Ground Zeroes\" /F /Y /S
REM xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Just Cause 3\" /F /Y /S
