...
xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\DiRT Rally\" /F /Y
...
xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Batman The Telltale Series\" /F /Y
xcopy /C "%1*.*" "W:\SteamLibrary\SteamApps\common\Dishonored2\" /F /Y