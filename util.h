...
// To use this function be sure to terminate an Enum_Name_t list with {NULL, 0}
// as it cannot use ArraySize on passed in arrays.
template <class T1, class T2>
static T2 lookup_enum_val(struct Enum_Name_t<T1, T2>* enum_names, T1 name, T2 type, bool* found = nullptr)
{
...
template <class T1, class T2>
static T2 lookup_enum_val(struct Enum_Name_t<T1, T2>* enum_names, T1 name, size_t len, T2 type, bool* found = nullptr)
{
    for (; enum_names->name; enum_names++)
    {
...
template <class T1, class T2>
static T1 lookup_enum_name(struct Enum_Name_t<T1, T2>* enum_names, T2 val)
{
    for (; enum_names->name; enum_names++)
    {
...
template <class T2>
static std::wstring lookup_enum_bit_names(struct Enum_Name_t<const wchar_t*, T2>* enum_names, T2 val)
{
    std::wstring ret;
    T2           remaining = val;
...
// operators. As above, the Enum_Name_t list must be terminated with {NULL, 0}
//
...
static T2 parse_enum_option_string(struct Enum_Name_t<T1, T2>* enum_names, T3 option_string, T1* unrecognised)
{
    ...
    while (*ptr)
    {
        ...
        else
        {
            ...
            {
                log_overlay_w(Log_Level::warning, L"WARNING: Unknown option: %s\n", cur);
                ret |= T2::INVALID;
            }
        }
    }
...
template <class T1, class T2>
static T2 parse_enum_option_string(struct Enum_Name_t<T1, T2>* enum_names, T1 option_string, T1* unrecognised)
{
